...
export const getWhatsNewPosts: RequestHandler<{}, {}, {}, {}> = async (_, res, next) => {
  try {
...
export const getWhatsHotPosts: RequestHandler<{}, {}, {}, {}> = async (_, res, next) => {
  try {
...
export const getPost: RequestHandler<{ id: string }, {}, {}, {}> = async (req, res, next) => {
  try {
...
export const getPostsByMe: RequestHandler<{}, {}, {}, { userId: Types.ObjectId }> = async (req, res, next) => {
  try {
    const PostModel = await postModel()
...
export const addPost: RequestHandler<{}, {}, { title: string, text: string }, { userId: Types.ObjectId }> = async (req, res, next) => {
  try {
    const PostModel = await postModel()
...
export const editPost: RequestHandler<{ id: string }, {}, { title: string, text: string }, { userId: Types.ObjectId }> = async (req, res, next) => {
  try {
    const PostModel = await postModel()
    const post = await PostModel.findOne({ _id: Types.ObjectId(req.params.id) }).exec()
    if (post) {
...
export const deletePost: RequestHandler<{ id: string }, {}, {}, { userId: Types.ObjectId }> = async (req, res, next) => {
  try {
